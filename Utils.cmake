...
function(set_custom_build_properties TARGET_NAME)
    ...
    set_target_properties(${TARGET_NAME}
        PROPERTIES
        ARCHIVE_OUTPUT_DIRECTORY ${SOURCE_DIR}/bin/${BUILD_CONFIG}/${TARGET_NAME}-${CMAKE_SYSTEM_NAME}-${CMAKE_SYSTEM_PROCESSOR}/
        LIBRARY_OUTPUT_DIRECTORY ${SOURCE_DIR}/bin/${BUILD_CONFIG}/${TARGET_NAME}-${CMAKE_SYSTEM_NAME}-${CMAKE_SYSTEM_PROCESSOR}/
        RUNTIME_OUTPUT_DIRECTORY ${SOURCE_DIR}/bin/${BUILD_CONFIG}/${TARGET_NAME}-${CMAKE_SYSTEM_NAME}-${CMAKE_SYSTEM_PROCESSOR}/
